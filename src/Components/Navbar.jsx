...
const Navbar = () => {
    ...
    return (
        <div className="relative w-screen h-max bg-white hidden lg:flex px-12 py-6 items-center justify-between pz-12 shadow-md z-[9999999999]">
            <img src={Logo} alt="logo-mitranet" />
            ...
            <div className="w-max px-8 h-max py-3 bg-mainColor text-white flex items-center justify-center ml-[100px] rounded-[8px] text-white cursor-pointer hover:brightness-[90%] active:scale-[0.98]">
                <p>Daftar</p>
            </div>
        </div>
    );
